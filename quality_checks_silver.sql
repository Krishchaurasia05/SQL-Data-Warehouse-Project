...
WHERE sls_order_date > sls_shipping_date 
...
WHERE e_cst_birth_date < '1924-01-01' 
   OR e_cst_birth_date > GETDATE();
...
WHERE px_category != TRIM(px_category) 
   OR px_sub_category != TRIM(px_sub_category) 
